...
## About Scripts
As mentioned in our paper, we use [PIG-VAE](https://github.com/jrwnter/pigvae.git) for molecular graph autoencoder architecture. The code for the PIG-VAE can be found in `pigvae_all/pigvae`.
